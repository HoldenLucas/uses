...
This can be managed by a single developer. It is inexpensive to get started, and scales absurdly well.
...
### [fly.io](https://fly.io/)
- if you run it in an OCI container (Docker/Podman), you can run it on Fly in [10 minutes](https://fly.io/speedrun/)
...
- use under 5$ a month is free
- automatic staging previews per PR with [fly-pr-review-apps](https://github.com/superfly/fly-pr-review-apps)
...
- notable extensions
    ...
    - [GSConnect](https://github.com/GSConnect/gnome-shell-extension-gsconnect)
        - lets you control Gnome from your phone and vice versa
            - I get a Gnome notification when my phone battery is low
            - I use my phone's touchscreen as a trackpad to control Gnome
...
- my preferred collection of mods
    - Caps lock -> ESC
        - I press ESC infinitely more than I find myself typing in allcaps
    - home row mods
...
- supports some cool features
    ...
    - wildcard delivery
        - I use `$SERVICE_NAME@holdenlucas.com` for every `$SERVICE` and they all go to one email
...
- the browser extension is well thought out and always acts how I would want/expect
- open source!
